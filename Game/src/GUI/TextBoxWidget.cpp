...
TextBoxWidget::TextBoxWidget(std::string text, GLfloat r, GLfloat g, GLfloat b, GLfloat a, void * font, GLfloat xPos, GLfloat yPos): TextWidget(text, r, g, b, a, font, xPos, yPos) {
...
void TextBoxWidget::draw() {
	...
	if(focused) {
		...
		glVertex2f(textSize + 1, getMinimumHeight());
		glVertex2f(textSize + 1, 0);
		glEnd();
	}
}
